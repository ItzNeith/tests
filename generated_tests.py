...
def test_file_example_soma():
    assert file_example.soma(1, 2) == 3
...
# Testa a função dividir para verificar se a divisão está correta e se a exceção é lançada
...
# Testa a função inutil para verificar se a função retorna a string esperada
