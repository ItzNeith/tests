...
# Testa a função esta_ativo para verificar se o retorno é correto para True e False
...
def test_file_example_subtracao():
    ...
    assert file_example.subtracao(0, 5) == -5
...
# Testa a função inutil para verificar se ela retorna a string correta
