...
# Testa a função esta_ativo para verificar se o retorno é verdadeiro quando a flag é True.
...
# Testa a função dividir para verificar se a divisão de dois números está correta e se a exceção é lançada corretamente.
...
def test_file_example_classificar():
    ...
    assert file_example.classificar(0) == "Reprovado"